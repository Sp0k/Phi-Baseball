...
function HomePage() {
  ...
  return (
    <main className="fixed top-12 sm:top-14 w-full h-full sm:left-10 lg:left-18">
      ...
      <Link to={`/devlog#v${versionNum}`} className="absolute top-30 left-138 inline-flex justify-center items-center py-1 px-1 pr-4 mb-7 text-sm text-gray-700 bg-gray-100 rounded-full dark:bg-gray-800 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700" role="alert">
